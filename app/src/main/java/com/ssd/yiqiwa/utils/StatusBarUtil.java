...
import com.ssd.yiqiwa.widget.StatusBarView;
...
public class StatusBarUtil {
     ...
     * @param drawerLayout DrawerLayout
     */
    private static void setTranslucentForDrawerLayout(Activity activity, DrawerLayout drawerLayout, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
