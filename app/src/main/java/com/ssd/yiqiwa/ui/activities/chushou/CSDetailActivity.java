...
public class CSDetailActivity extends BaseActivity {
    ...
    public Object offerLayout() {
        return R.layout.cs_activity_detail;
    }
...
//        uriList.remove(uriList.size()-1);
    ...
    public void getRentOutDetail(int roId){
        ...
        call.enqueue(new Callback<BaseBean<MacBuyPoBean>>() {
            ...
            public void onResponse(Call<BaseBean<MacBuyPoBean>> call, Response<BaseBean<MacBuyPoBean>> response) {
                hideDialog();
                BaseBean<MacBuyPoBean> baseBean = response.body();
    ...
    private void initViewData(MacBuyPoBean macRentOutPoBean){
        ...
        txt_head_01.setText(macRentOutPoBean.getRentFrom());
        txt_head_02.setText(macRentOutPoBean.getWorkTime()+macRentOutPoBean.getWorkTimeUint());
        ...
        if(!macRentOutPoBean.getTonnage().isEmpty()) {
            txt_cs_02.setText(macRentOutPoBean.getTonnage());
        }else{
            txt_cs_02.setText("-");
        }
        txt_cs_03.setText(macRentOutPoBean.getStandard());
        txt_cs_04.setText(macRentOutPoBean.getCount());
        txt_cs_05.setText(macRentOutPoBean.getArrivalTime());
