 ...
 * 预约订单列表
 */
public class OrderBuySellActivity extends BaseActivity {
    ...
    private OrderBuySellListAdapter yuyueListAdapter;

    private List<MacOrderSubPo> macOrderSubPos = new ArrayList<>();

    public static void start(Context context){
        Intent intent=new Intent(context, OrderBuySellActivity.class);
    ...
    public void onBindView() {
        ...
        txt_title.setText("购买记录");

        recyYuyueList.setLayoutManager(new LinearLayoutManager(activity));
        yuyueListAdapter = new OrderBuySellListAdapter(activity, macOrderSubPos, this::getOderFollowOrder);
    ...
    public void getOrderMangerReserveOrder(){
        ...
        Call<BaseBean<PagesBean<MacOrderSubPo>>> call = request.orderUserBuySellOrder(18,pageNo);
