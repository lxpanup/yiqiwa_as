package com.ssd.yiqiwa.ui.activities.chushou;
...
import com.ssd.yiqiwa.ui.adapter.CSProductAdapter;
...
public class CSListActivity extends BaseActivity {
    ...
    private List<MacBuyPoBean> macRentOutPoBeans = new ArrayList<>();

    private CSProductAdapter czProductAdapter;

    @Override
    public Object offerLayout() {
        return R.layout.cs_activity_list;
    }
    ...
    public void onBindView() {
        ...
        czProductAdapter =  new CSProductAdapter(activity,macRentOutPoBeans);
    ...
    public void onViewClick(View v){
        switch (v.getId()){
            ...
            case R.id.img_list_fabu:
                startActivity(new Intent(CSListActivity.this,CZPublishActivity.class));
                break;
            case R.id.txt_list_saixuan:
                startActivity(new Intent(CSListActivity.this,CZShaixuanActivity.class));
                break;
    ...
    public void showCityList(TextView textView){
        CityPicker.from(CSListActivity.this)
...
//                        }, 3000);
    ...
    public void getRentOutList(){
        ...
        Call<BaseBean<PagesBean<MacBuyPoBean>>> call = request.buyList(1);
        call.enqueue(new Callback<BaseBean<PagesBean<MacBuyPoBean>>>() {
            //请求成功时回调
            @Override
            public void onResponse(Call<BaseBean<PagesBean<MacBuyPoBean>>> call, Response<BaseBean<PagesBean<MacBuyPoBean>>> response) {
                hideDialog();
                BaseBean<PagesBean<MacBuyPoBean>> baseBeanList = response.body();
            ...
            //请求失败时回调
            @Override
            public void onFailure(Call<BaseBean<PagesBean<MacBuyPoBean>>> call, Throwable throwable) {
                LogUtils.e("请求失败");
