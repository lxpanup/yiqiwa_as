...
public class HomeProductAdapter extends RecyclerView.Adapter<HomeProductAdapter.MyHolder> {
    ...
    public HomeProductAdapter(Context context, List<String> mList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        holder.txt_product_name.setText(mList.get(position));
    }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            ...
            lil_item_product.setOnClickListener(new View.OnClickListener() {
                @Override
