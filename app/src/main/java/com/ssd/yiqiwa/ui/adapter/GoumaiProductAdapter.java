 ...
 * 商品列表adapter
 */
public class GoumaiProductAdapter extends RecyclerView.Adapter<GoumaiProductAdapter.MyHolder> {
    private Context context;
    private MainActivity activity;
    public List<MacSellPoBean> mList;


    public GoumaiProductAdapter(Context context, List<MacSellPoBean> mList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        MacSellPoBean macRentOutPoBean = mList.get(position);
        ...
        holder.lil_item_product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(context, GoumaiDetailActivity.class);
                intent.putExtra("productRoId",macRentOutPoBean.getsId());
